...
public final class RemoveDuplicatesCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(RemoveDuplicatesCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    RemoveDuplicates command = new RemoveDuplicates();
